...
storefrontApp.controller('checkoutController', ['$rootScope', '$scope', '$window', 'cartService',
    function ($rootScope, $scope, $window, cartService) {
        ...
        function createOrder() {
            var expirationDate = $scope.checkout.bankCardInfo.expirationDate;
            if (expirationDate) {
                $scope.checkout.bankCardInfo.bankCardMonth = parseInt(expirationDate.substr(0, 2));
                $scope.checkout.bankCardInfo.bankCardYear = parseInt(expirationDate.substr(expirationDate.indexOf('/') + 2, 2));
            }
        ...
        function validateBankCardNumber() {
            var bankCardNumber = $scope.checkout.bankCardInfo.bankCardNumber;
            ...
            $scope.checkout.bankCardInfo.bankCardType = cardType;
