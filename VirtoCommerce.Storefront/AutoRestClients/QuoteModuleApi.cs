...
namespace VirtoCommerce.Storefront.AutoRestClients.QuoteModuleApi.Models
{
    ...
    public partial class QuoteRequestSearchCriteria
    {
        ...
        /// Initializes a new instance of the QuoteRequestSearchCriteria class.
        /// </summary>
        public QuoteRequestSearchCriteria(string number = default(string), string keyword = default(string), string customerId = default(string), string storeId = default(string), System.DateTime? startDate = default(System.DateTime?), System.DateTime? endDate = default(System.DateTime?), string status = default(string), string tag = default(string), int? start = default(int?), int? count = default(int?))
        {
            Number = number;
            Keyword = keyword;
